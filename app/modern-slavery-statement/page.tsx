      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-gray prose-lg">
            ...
            <p>
              JBAF CONSULTING LTD (&quot;we&quot;, &quot;us&quot; or &quot;our&quot;) is committed to preventing slavery and human trafficking violations in its own operations, its supply chain, and its products. We have zero-tolerance towards slavery and require our supply chain to comply with our values.
            </p>

            <h2>2. Organisational Structure</h2>
            <p>
              JBAF CONSULTING LTD is a private limited company incorporated in England and Wales, with business operations in the United Kingdom.
            </p>
            <p>
