        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-4">
          {values.map((value, index) => {
            ...
            return (
              ...
              >
                <div className={`${iconWrapClass} w-16 h-16 lg:w-12 lg:h-12 rounded-lg flex items-center justify-center mb-6 lg:mb-4 transition-all duration-300 ease-out lg:group-hover:brightness-110 lg:group-hover:border-primary-200/80`}>
                  <Icon className={`h-8 w-8 lg:h-6 lg:w-6 ${iconClass} transition-transform duration-300 ease-out lg:group-hover:scale-105`} />
                </div>
                <h3 className="text-xl lg:text-lg font-semibold font-heading mb-3 lg:mb-2 text-gray-900">
                  {value.title}
                </h3>
